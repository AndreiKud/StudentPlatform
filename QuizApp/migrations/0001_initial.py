# Generated by Django 2.2.12 on 2020-05-26 00:33
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quiz', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='QuizApp.Quiz', verbose_name='Quiz')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='QuizApp.Category', verbose_name='Category')),
                ('quiz', models.ManyToManyField(blank=True, to='QuizApp.Quiz', verbose_name='Quiz')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file', models.FileField(upload_to=QuizApp.models.upload_csv_file, validators=[QuizApp.validators.csv_file_validator])),
