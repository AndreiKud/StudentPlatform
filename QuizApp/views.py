...
class ViewQuizListByCategory(ListView):
    model = Quiz
    template_name = 'QuizApp/view_quiz_category.html'
...
class QuizUserProgressView(TemplateView):
    template_name = 'QuizApp/progress.html'
...
class QuizTake(FormView):
    ...
    def dispatch(self, request, *args, **kwargs):
        ...
        if self.sitting is False:
            return render(request, 'QuizApp/single_complete.html')
    ...
    def final_result_user(self):
        ...
        return render(self.request, 'QuizApp/result.html', results)
